...
import CharacterCardCanvas from "@/pages/scripts/component/scripts-character-role/canvas/CharacterCardCanvas.tsx";
...
const ScriptEditor = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'characters':
        return (
          <CharacterCardCanvas project={project} projectId={project?.id} />
        );
      case 'outline':
        return (
